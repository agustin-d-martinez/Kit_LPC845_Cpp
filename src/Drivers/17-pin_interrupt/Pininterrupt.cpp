...
/**
	\fn void Pin_interrupt::PinInterrupt_Enable_clock( void )
...
/**
	\fn void Pin_interrupt::EnableInterupt( void )
...
/**
	\fn void Pin_interrupt::DisableInterupt( void )
...
/**
	\fn Pin_interrupt::Pin_interrupt( port_t port , uint8_t bit , uint8_t gpio_mode , activity_t activity , uint8_t intrp_mode )
...
*/
Pin_interrupt::Pin_interrupt( port_t port , uint8_t bit , mode_t gpio_mode , activity_t activity , uint8_t intrp_mode )
...
/**
	\fn void Pin_interrupt::PinInterrupt_Inicializar( void )
...
Pin_interrupt::~Pin_interrupt() /*Es solo simbólico, puesto que no se van a destruir nunca estos objetos*/
{
	DisableInterupt();
	m_cant--;
}
