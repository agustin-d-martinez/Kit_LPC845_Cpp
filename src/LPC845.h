 ...
 * @{
 */
#define FRO_FREQ		(12000000UL)	/**< Frecuencia base, 12 KHz */
#define M				3				/**< Multiplicador de frecuencia. Puede ir de 1 a 32 */
#define P				1				/**< Divisor de frecuencia. Puede tomar valores de 1, 2, 4 u 8*/

/** Frecuencia principal del LPC845*/
#define FREQ_PRINCIPAL	((FRO_FREQ * (M+1)) / P)	//En Hz. Con M=3 y P=1, FREQ_PRINCIPAL = 48 MHz
